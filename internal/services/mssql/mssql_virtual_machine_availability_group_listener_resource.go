...
var _ sdk.ResourceWithUpdate = MsSqlVirtualMachineAvailabilityGroupListenerResource{}
...
func (r MsSqlVirtualMachineAvailabilityGroupListenerResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			existing, err := client.Get(ctx, id, availabilitygrouplisteners.GetOperationOptions{Expand: utils.String("*")})
			if err != nil {
...
func (r MsSqlVirtualMachineAvailabilityGroupListenerResource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			resp, err := client.Get(ctx, *id, availabilitygrouplisteners.GetOperationOptions{Expand: utils.String("*")})
			if err != nil {
			...
			if model := resp.Model; model != nil {
				if props := model.Properties; props != nil {
					...
					avGroupListenerLbConfigs, err := flattenMsSqlVirtualMachineAvailabilityGroupListenerLoadBalancerConfigurations(props.LoadBalancerConfigurations)
					if err != nil {
...
func (r MsSqlVirtualMachineAvailabilityGroupListenerResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			var model MsSqlVirtualMachineAvailabilityGroupListenerModel
...
func flattenMsSqlVirtualMachineAvailabilityGroupListenerLoadBalancerConfigurations(input *[]availabilitygrouplisteners.LoadBalancerConfiguration) ([]helper.LoadBalancerConfigurationMsSqlVirtualMachineAvailabilityGroupListener, error) {
