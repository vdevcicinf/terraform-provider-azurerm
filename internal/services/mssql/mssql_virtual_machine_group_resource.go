		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if model := resp.Model; model != nil {
				if props := model.Properties; props != nil {
					...
					state.WsfcDomainProfile = flattenMsSqlVirtualMachineGroupWsfcDomainProfile(metadata, props.WsfcDomainProfile)
...
func flattenMsSqlVirtualMachineGroupWsfcDomainProfile(metadata sdk.ResourceMetaData, domainProfile *sqlvirtualmachinegroups.WsfcDomainProfile) []helper.WsfcDomainProfile {
	...
	var storageAccountPrimaryKey string
	if v := metadata.ResourceData.Get("storage_account_primary_key"); v != nil {
		storageAccountPrimaryKey = v.(string)
	}
