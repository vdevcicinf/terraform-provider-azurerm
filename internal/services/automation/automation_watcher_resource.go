...
func (m WatcherResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, meta sdk.ResourceMetaData) error {
			...
			accountID, _ := automationaccount.ParseAutomationAccountID(model.AutomationAccountID)
			...
			param := watcher.Watcher{
				Properties: &watcher.WatcherProperties{
					...
					Status:                      utils.String(model.Description),
				},
		...
		Func: func(ctx context.Context, meta sdk.ResourceMetaData) error {
			...
			if model := resp.Model; model != nil {
				if props := resp.Model.Properties; props != nil {
					output.AutomationAccountID = automationaccount.NewAutomationAccountID(id.SubscriptionId, id.ResourceGroupName, id.AutomationAccountName).ID()
